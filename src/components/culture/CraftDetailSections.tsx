...
const CraftDetailSections = ({ craft }: CraftDetailSectionsProps) => {
    return (
        <div className="container mx-auto px-4 py-12 space-y-16">
            ...
            {/* Main Grid Layout: 2/3 Content, 1/3 Sidebar */}
            <div className="grid md:grid-cols-3 gap-12">
                ...
                {/* RIGHT COLUMN: Sidebar (Quick Facts + Major Centres) */}
                <div className="space-y-8 sticky top-24 h-fit">
                    ...
                    {/* Major Centres (Now in Sidebar) */}
                    <div>
                        <h2 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                            <MapPin className="text-primary h-5 w-5" /> Major Centres
                        </h2>
                        <div className="space-y-4">
