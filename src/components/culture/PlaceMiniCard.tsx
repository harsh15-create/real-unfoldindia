...
export function PlaceMiniCard({ place }: PlaceMiniCardProps) {
    return (
        <div className="bg-white/5 border border-white/10 rounded-xl p-5 hover:border-purple-500/30 hover:bg-white/10 transition-colors flex flex-col justify-between h-full">
            <div>
